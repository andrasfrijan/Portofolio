const hours_needle = document.querySelector('.hours-arrow');
const minutes_needle = document.querySelector('.minutes-arrow');
const seconds_needle = document.querySelector('.seconds-arrow');
